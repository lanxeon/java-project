...
public class workController {
	...
	public ModelAndView getByID(@RequestParam("id") String id)//@ModelAttribute("id") String id)
	{
		...
		works.add(w);
		ModelAndView model = new ModelAndView("getBy");
	...
	//for college
		...
		//for organizer
				@RequestMapping(value= "/getWorkshopsByOrganiser", method = RequestMethod.GET)
				public ModelAndView EnterOrganizer()
				{
					return new ModelAndView("enterOrganiser");
				}
				
				@RequestMapping(value= "/getWorkshopsByOrganiser", method = RequestMethod.POST)
				public ModelAndView getByOrganiser(@RequestParam("organiser") String organiser)
				{
